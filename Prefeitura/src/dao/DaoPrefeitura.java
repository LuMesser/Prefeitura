...
public class DaoPrefeitura {
     public static boolean inserir(Prefeitura objeto) {
        String sql = "INSERT INTO prefeitura (nome, endereco, nrfuncionario) VALUES (?, ?, ?)";
        try {
            PreparedStatement ps = conexao.Conexao.getConexao().prepareStatement(sql);
            ps.setString(1, objeto.getNome());
            ps.setString(2, objeto.getEndereco());
            ps.setInt(3, objeto.getNrfuncionario());
            ps.executeUpdate();
            return true;
      ...
      public static void main(String[] args) {
        ...
        objeto.setNome("Municipal");
        objeto.setEndereco("Ibirubá");
        objeto.setNrfuncionario(1);
      ...
      public static boolean alterar(Prefeitura objeto) {
        String sql = "UPDATE prefeitura SET nome = ?, endereco = ?, nrfuncionario = ? WHERE codigo=?";
        try {
            PreparedStatement ps = conexao.Conexao.getConexao().prepareStatement(sql);
            ps.setString(1, objeto.getNome()); 
            ps.setString(2, objeto.getEndereco());
        ...
        String sql = "SELECT codigo, nome, endereco, nrfuncionario FROM prefeitura";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                objeto.setNrfuncionario(rs.getInt("nrfuncionario"));
        ...
        //editar o SQL conforme a entidade
        String sql = "SELECT codigo, nome, endereco, nrfuncionario FROM prefeitura WHERE codigo=?";
        PreparedStatement ps;
        try {
            ps = conexao.Conexao.getConexao().prepareStatement(sql);
